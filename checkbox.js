...
$('.Checkbox70').change(function () {
    ...
    $('.Checkbox70').prop('checked', true);
        ...
        $('.Checkbox70').prop('checked', false);
    }
});
$('.Checkbox70').trigger('change');

$('.Checkbox71').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox71').prop('checked', true);
    }
    else {
        $('.Checkbox71').prop('checked', false);
    }
});
$('.Checkbox71').trigger('change');

$('.Checkbox72').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox72').prop('checked', true);
    }
    else {
        $('.Checkbox72').prop('checked', false);
    }
});
$('.Checkbox72').trigger('change');

$('.Checkbox73').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox73').prop('checked', true);
    }
    else {
        $('.Checkbox73').prop('checked', false);
    }
});
$('.Checkbox73').trigger('change');

$('.Checkbox74').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox74').prop('checked', true);
    }
    else {
        $('.Checkbox74').prop('checked', false);
    }
});
$('.Checkbox74').trigger('change');

$('.Checkbox75').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox75').prop('checked', true);
    }
    else {
        $('.Checkbox75').prop('checked', false);
    }
});
$('.Checkbox5').trigger('change');
...
$('.Checkbox76').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox76').prop('checked', true);
    }
    else {
        $('.Checkbox76').prop('checked', false);
    }
});
$('.Checkbox76').trigger('change');

$('.Checkbox77').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox77').prop('checked', true);
    }
    else {
        $('.Checkbox77').prop('checked', false);
    }
});
$('.Checkbox77').trigger('change');

$('.Checkbox78').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox78').prop('checked', true);
    }
    else {
        $('.Checkbox78').prop('checked', false);
    }
});
$('.Checkbox78').trigger('change');

$('.Checkbox79').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox79').prop('checked', true);
    }
    else {
        $('.Checkbox79').prop('checked', false);
    }
});
$('.Checkbox79').trigger('change');

$('.Checkbox80').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox80').prop('checked', true);
    }
    else {
        $('.Checkbox80').prop('checked', false);
    }
});
$('.Checkbox80').trigger('change');
...
$('.Checkbox81').trigger('change');

$('.Checkbox82').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox82').prop('checked', true);
    }
    else {
        $('.Checkbox82').prop('checked', false);
    }
});
$('.Checkbox82').trigger('change');
...
$('.Checkbox83').change(function () {
    ...
    $('.Checkbox83').prop('checked', true);
        ...
        $('.Checkbox83').prop('checked', false);
    }
});
$('.Checkbox83').trigger('change');

$('.Checkbox84').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox84').prop('checked', true);
    }
    else {
        $('.Checkbox84').prop('checked', false);
    }
});
$('.Checkbox84').trigger('change');

$('.Checkbox85').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox85').prop('checked', true);
    }
    else {
        $('.Checkbox85').prop('checked', false);
    }
});
$('.Checkbox85').trigger('change');

$('.Checkbox86').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox86').prop('checked', true);
    }
    else {
        $('.Checkbox86').prop('checked', false);
    }
});
$('.Checkbox86').trigger('change');

$('.Checkbox87').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox87').prop('checked', true);
    }
    else {
        $('.Checkbox87').prop('checked', false);
    }
});
$('.Checkbox87').trigger('change');

$('.Checkbox88').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox88').prop('checked', true);
    }
    else {
        $('.Checkbox88').prop('checked', false);
    }
});
$('.Checkbox88').trigger('change');

$('.Checkbox89').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox89').prop('checked', true);
    }
    else {
        $('.Checkbox89').prop('checked', false);
    }
});
$('.Checkbox89').trigger('change');

$('.Checkbox90').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox90').prop('checked', true);
    }
    else {
        $('.Checkbox90').prop('checked', false);
    }
});
$('.Checkbox90').trigger('change');

$('.Checkbox91').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox91').prop('checked', true);
    }
    else {
        $('.Checkbox91').prop('checked', false);
    }
});
$('.Checkbox91').trigger('change');

$('.Checkbox92').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox92').prop('checked', true);
    }
    else {
        $('.Checkbox92').prop('checked', false);
    }
});
$('.Checkbox92').trigger('change');

$('.Checkbox93').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox93').prop('checked', true);
    }
    else {
        $('.Checkbox93').prop('checked', false);
    }
});
$('.Checkbox93').trigger('change');

$('.Checkbox94').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox94').prop('checked', true);
    }
    else {
        $('.Checkbox94').prop('checked', false);
    }
});
$('.Checkbox94').trigger('change');

$('.Checkbox95').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox95').prop('checked', true);
    }
    else {
        $('.Checkbox95').prop('checked', false);
    }
});
$('.Checkbox95').trigger('change');

$('.Checkbox96').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox96').prop('checked', true);
    }
    else {
        $('.Checkbox96').prop('checked', false);
    }
});
$('.Checkbox96').trigger('change');

$('.Checkbox97').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox97').prop('checked', true);
    }
    else {
        $('.Checkbox97').prop('checked', false);
    }
});
$('.Checkbox97').trigger('change');

$('.Checkbox98').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox98').prop('checked', true);
    }
    else {
        $('.Checkbox98').prop('checked', false);
    }
});
$('.Checkbox98').trigger('change');
...
$('.Checkbox99').trigger('change');

$('.Checkbox100').change(function () {
    if ($(this).prop('checked')) {
    $('.Checkbox100').prop('checked', true);
    }
    else {
        $('.Checkbox100').prop('checked', false);
    }
});
$('.Checkbox100').trigger('change');